...
func TestRSNAKMString(t *testing.T) {
	tests := []struct {
		...
		{RSNAkm_RESERVED_0, "Reserved‑0"},
		{RSNAkm_8021X, "802.1X"},
		{RSNAkm_PSK, "PSK"},
		{RSNAkm_FT_8021X, "FT‑802.1X"},
		{RSNAkm_FT_PSK, "FT‑PSK"},
		{RSNAkm_8021X_SHA256, "802.1X‑SHA256"},
		{RSNAkm_PSK_SHA256, "PSK‑SHA256"},
		{RSNAkm_TDLS, "TDLS"},
		{RSNAkm_SAE, "SAE"},
		{RSNAkm_FT_SAE, "FT‑SAE"},
		{RSNAkm_AP_PEERKEY, "AP‑PeerKey"},
		{RSNAkm_8021X_SUITE_B, "802.1X‑Suite‑B"},
		{RSNAkm_8021X_CNSA, "802.1X‑CNSA"},
		{RSNAkm_FT_8021X_SHA384, "FT‑802.1X‑SHA384"},
		{RSNAkm_FILS_SHA256, "FILS‑SHA256"},
		{RSNAkm_FILS_SHA384, "FILS‑SHA384"},
		{RSNAkm_FT_FILS_SHA256, "FT‑FILS‑SHA256"},
		{RSNAkm_FT_FILS_SHA384, "FT‑FILS‑SHA384"},
		{RSNAkm_RESERVED_18, "Reserved‑18"},
		{RSNAkm_FT_PSK_SHA384, "FT‑PSK‑SHA384"},
		{RSNAkm_PSK_SHA384, "PSK‑SHA384"},
	...
	tests := []struct {
		...
		},
		{
			...
			rsn: RSNInfo{
				...
				AKMs:            []RSNAKM{RSNAkm_SAE, RSNAkm_PSK},
			},
		...
		},
		{
			...
			rsn: RSNInfo{
				...
				GroupCipher:     RSNCipherCCMP128,
				PairwiseCiphers: []RSNCipher{RSNCipherCCMP128},
				AKMs:            []RSNAKM{RSNAkm_8021X, RSNAkm_FT_8021X},
			},
